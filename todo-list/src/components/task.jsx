...
const Task = ({task,onDelete,onEdit}) => {
    ...
    return (
        ...
        <div className="h-fit p-5 flex gap-3 flex-col justify-center   primary rounded-xl shadow-xl">

            <div  id="line" >
                <input type={'text'} className=" w-[100%] uppercase  text-center underline-offset-2 underline    font-extrabold  textColor flex justify-center  h-fit  primary overflow-y-auto break-words font-mono text-xl pointer-events-none" value={text}  onChange={(e) => setText(e.target.value)}/>
                {
                    description !=='' &&
