    ...
    return (
        <div className="h-fit p-3 flex gap-3 flex-col mt-6 bg-white rounded-xl shadow-xl">
            <div className="unline" id="line" >
                <input ref={ref} type="text" maxLength={15} className=" w-[100%] text-center h-fit shadow-none bg-transparent overflow-y-auto break-words font-mono text-xl" readOnly={edit}  value={text} onChange={(e) => setText(e.target.value)}/>
            </div>
